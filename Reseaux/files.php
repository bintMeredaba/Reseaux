...
$total_files = $result_count->fetch_assoc()['total_files'];
  ...
  <div class="container-fluid p-0">
    <div class="row g-0">
      ...
      <div class="col-lg-10">
        ...
        <!-- Files Content -->
        <div class="container-fluid" id="files-content">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800 page-title">Gestion des Fichiers</h1>
            <button class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" data-bs-toggle="modal" data-bs-target="#uploadModal">
              <i class="fas fa-upload fa-sm text-white-50 me-2"></i>Uploader un fichier
            </button>
          </div>
          <a href="acces.php" class="d-none d-sm-inline-block btn btn-sm btn-info shadow-sm">
            <i class="fas fa-desktop fa-sm text-white-50 me-2"></i>Accès distant
          </a>
                    ...
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            echo "<tr>
                                    ...
                                    <td>
                                      <a href='updatefichier.php?id={$row['id']}' class='btn btn-sm btn-warning'>Modifier</a>
                                      <a href='suppfichier.php?id={$row['id']}' class='btn btn-sm btn-danger' onclick=\"return confirm('Êtes-vous sûr de vouloir supprimer ce fichier ?');\">Supprimer</a>
                                    </td>
                                   
                                  </tr>";
                        }
                    } else {
                        echo "<tr><td colspan='4'>Aucun fichier trouvé</td></tr>";
                    }
                    ?>
                  </tbody>
                </table>
