  ...
  <div class="container-fluid p-0">
    <div class="row g-0">
      ...
      <div class="col-lg-10">
        ...
        <!-- Employees Content -->
        <div class="container-fluid" id="employees-content">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800 page-title">Gestion des Employés</h1>
            <button class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" data-bs-toggle="modal" data-bs-target="#addEmployeeModal">
              <i class="fas fa-plus fa-sm text-white-50 me-2"></i>Ajouter un employé
            </button>
          </div>
                    ...
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            echo "<tr>
                                    ...
                                    <td>{$row['email']}</td>
                                    <td>
                                      <a href='updateE.php?id={$row['id']}' class='btn btn-sm btn-warning'><i class='fas fa-edit'></i></a>
                                      <a href='deleteE.php?id={$row['id']}' class='btn btn-sm btn-danger'><i class='fas fa-trash'></i></a>
                                    </td>
                                  </tr>";
                        }
                    } else {
        ...
        <div class="modal-body">
          <form action="addE.php" method="POST">
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="employeeName" name="nom" placeholder="Entrez le nom" required>
            </div>
            <div class="mb-3">
              <label for="employeePosition" class="form-label">Poste</label>
              <input type="text" class="form-control" id="employeePosition" name="poste" placeholder="Entrez le poste" required>
            </div>
            <div class="mb-3">
              <label for="employeeEmail" class="form-label">Email</label>
              <input type="email" class="form-control" id="employeeEmail" name="email" placeholder="Entrez l'email" required>
            </div>
            <div class="mb-3">
              <label for="employeePrenom" class="form-label">Prenom</label>
              <input type="prenom" class="form-control" id="employeePrenom" name="prenom" placeholder="Entrez le prenom" required>
            <div class="mb-3">
              <label for="employeePassword" class="form-label">Mot de passe</label>
              <input type="password" class="form-control" id="employeePassword" name="password" placeholder="Entrez le mot de passe" required>
